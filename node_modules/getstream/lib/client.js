...
var StreamClient = exports.StreamClient = /*#__PURE__*/function () {
  ...
  function StreamClient(apiKey, apiSecretOrToken, appId) {
    ...
    (0, _defineProperty2.default)(this, "auditLogs", void 0);
    ...
    this.auditLogs = new _audit_logs.StreamAuditLogs(this, this.getOrCreateToken());
  ...
  (0, _createClass2.default)(StreamClient, [{
    ...
    key: "flagUser",
    value: function flagUser(targetUserId) {
